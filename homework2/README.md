...
------------
# How to run the Render Server
-----
### 1. Go to the URL
``` text
https://cs4300-8o27.onrender.com/bookings/
```

------------
# How to run the server on DevEdu
-----
...
Behave test cases made with the assistance of Claude AI.
